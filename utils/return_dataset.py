...
def return_dataset(args):
    base_path = './data/txt/%s' % args.domain
    root = './data/%s/' % args.domain
    image_set_file_s = \
    ...
    image_set_file_t = \
        os.path.join(base_path,
                     ...
                     args.target + '_%d.txt' % (args.n_shots))
...
def return_dataset_test(args):
    base_path = './data/txt/%s' % args.model_name
    root = './data/%s/' % args.model_name
